...
const Card = ({ img, linkedin, onClick, name, role }) => {
  return (
    <motion.div onClick={onClick} className='w-44 bg-[#1e1e1e] cursor-pointer sm:w-[16vw] drop-shadow-lg hover:scale-105 transition-all p-2 flex flex-col items-center rounded-lg'>

            ...
            <div className='flex flex-col w-[80%] mx-auto justify-center items-center m-16 mt-4 p-4 '>
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                ...
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                        <button className='bg-white p-3 text-2xl rounded-full hover:bg-emerald-400 shadow-2xl border' style={{ 'transform': 'rotate(0deg)', 'transitionDuration': '1s' }} onClick={() => view('2')} id='2'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>
                ...
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                        <button className='bg-white p-3 text-2xl rounded-full hover:bg-emerald-400 shadow-2xl border' style={{ 'transform': 'rotate(0deg)', 'transitionDuration': '1s' }} onClick={() => view('3')} id='3'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>
                ...
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                        <button className='bg-white p-3 text-2xl rounded-full hover:bg-emerald-400 shadow-2xl border' style={{ 'transform': 'rotate(0deg)', 'transitionDuration': '1s' }} onClick={() => view('4')} id='4'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>
                ...
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                        <button className='bg-white p-3 text-2xl rounded-full hover:bg-emerald-400 shadow-2xl border' style={{ 'transform': 'rotate(0deg)', 'transitionDuration': '1s' }} onClick={() => view('5')} id='5'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>
                ...
                <div className='w-full bg-white '>
                    ...
                    <div className='transition-all duration-1000 flex justify-between items-center  px-2'>
                        <h1 className='font-bold text-xl text-gray-800 py-2'>Accordion 1</h1>
                        <button className='bg-white p-3 text-2xl rounded-full hover:bg-emerald-400 shadow-2xl border' style={{ 'transform': 'rotate(0deg)', 'transitionDuration': '1s' }} onClick={() => view('6')} id='6'>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                        </button>

      ...
      <div className='flex flex-col justify-center items-center m-16 mt-4 p-4 '>
        ...
        <div className='flex mt-12 w-full p-2 justify-around text-xl font-[800]'>
          <div className=''>
            ...
            <p>16th November 2022 - Development Pitching</p>
          </div>
          <div>
        ...
        <div className='flex items-center w-full mt-12 text-2xl'>
          <img src={Aboutsvg} className='w-24 h-24 mx-6 ' />
          <div className='flex items-center w-full font-bold ml-20 gap-6'>
            <p className='shadow-lg shadow-[#00000030] p-2 px-4'>4</p>
            <p className='shadow-lg shadow-[#00000030] p-2 px-4'>2</p>
            <p className='shadow-lg shadow-[#00000030] p-2 px-4'>2</p>
            <p className='mx-2 text-3xl'>Connections since Hack with MAIT 1.0</p>
          </div>
        </div>
      </div>
    </div>
